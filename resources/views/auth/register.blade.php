                                    ...
                                    <div class="login-form-container">
                                        <div class="login-register-form">
                                            <form action="{{ route('register') }}" method="post">
                                                ...
                                                @enderror
                                                <input name="email" placeholder="ایمیل" type="email" value="{{old('email')}}" class="@error('email') mb-1 @enderror">
                                                @error('email')
                                                <div class="input-error-validation">
                                                    <strong>
                                                        {{$message}}
                                                ...
                                                <input type="password" name="user-password" value="{{old('user-password')}}" placeholder="رمز عبور" class="@error('password') mb-1 @enderror" >
                                                @error('user-password')
                                                <div class="input-error-validation">
                                                    <strong>
                                                        {{$message}}
                                                ...
                                                @enderror
                                                <input type="password" name="password_confirmation" placeholder="تکرار رمز عبور" value="{{old('password-confirmation')}}" class="@error('password-confirmation') mb-1 @enderror">
