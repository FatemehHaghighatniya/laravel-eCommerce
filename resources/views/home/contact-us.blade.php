...
{{--        marker.bindPopup("<b>موقعیت مکانی!</b><br>آموزشگاه").openPopup();--}}
{{--    </script>--}}
    <script>
        var mymap = L.map('map').setView([{{ $setting->latitude }}, {{ $setting->longitude }}], 15);
                ...
                <div class="contact-info-area">
                    ...
                    <div class="contact-info-wrap">
                        ...
                        <div class="single-contact-info">
                            ...
                            <div class="contact-info-content">
                                <p><a href="#">{{$setting->email_address}}</a> / <a href="#">{{$setting->instagram}}</a></p>
                            </div>
                        </div>
                        <div class="single-contact-info">
                            <div class="contact-info-icon">
