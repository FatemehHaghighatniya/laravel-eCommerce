                ...
                <div class="col-xl-2 col-lg-2">
                    <div class="logo pt-40">
                        <a href="{{route('home.index')}}">
                            <h3 class="font-weight-bold">vax.ir</h3>
                            <i class="sli sli-refresh"></i> <a href="{{route('home.compare.index')}}"> مقایسه محصولات</a>
                    ...
                    <div class="header-right-wrap pt-40">
                        ...
                        <div class="cart-wrap">
                            <button class="icon-cart-active">
                                ...
                                <span>تومان</span>
                                @else
                                    <span class="cart-price" style="font-size: 12px">سبد خالی است</span>
                                    ...
                                    <li class="single-shopping-cart">
                                        ...
                                        <div class="shopping-cart-img">
                                            <a href="{{route('home.products.show',['product'=>$item->associatedModel->slug])}}">
                                                <img alt="" src="{{asset(env('PRODUCT_IMAGES_UPLOAD_PATH').$item->associatedModel->primary_image)}}"></a>
            ...
            <div class="row align-items-center">
                <div class="col-6">
                    <div class="mobile-logo">
                        <a href="index.html">
                            <h4 class="font-weight-bold">vax.ir</h4>
                        </a>
                    </div>
                </div>
                <div class="col-6">
